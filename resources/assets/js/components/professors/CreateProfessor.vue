                    ...
                    <form action="#" id="form_sample_1" class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" v-model="professor.matric_no" data-required="1" placeholder="enter ID no" class="form-control input-height" /> </div>
                            </div>
                            <div class="form-group row">
                ...
                axios.post('/professor/add', this.professor)
                    .then(response => {
                        ...
                        if(_response.status == 0){
                            this.$notify({type: 'success', text: 'Professor added successfully', speed:400});
                        }
                        else{
